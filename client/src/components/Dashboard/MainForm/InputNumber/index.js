  ...
  render() {
    ...
    return (
      <div className='input-number'>
        <Input type='number' action={ amountArrowsLabel } label={ this.props.label } placeholder={ this.props.placeholder } size='tiny' onChange={ this.onChange.bind(this) } style={ { width: '50%' } }
          {...this.props.input}/>
